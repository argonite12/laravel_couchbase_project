...
namespace Yondu\Couchbase\Query;

use Couchbase\Exception;
use Illuminate\Support\Arr;
use Yondu\Couchbase\Helper;
...
class Builder extends BaseBuilder
{
    ...
    {
        return 'synapse_dev.yondu_subunit.yondu_subunit_data';
    }
    ...
    /**
     * Returns true if Laravel or Lumen >= 11.0
     *
     * @return bool
     */
    ...
    {
        $this->from = $this->connection->getBucketName().'.'.$table.'.'.$table.'_data';
        //$this->type = $table;
