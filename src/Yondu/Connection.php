...
use Yondu\Couchbase\Events\QueryFired;
use Yondu\Couchbase\Query\Builder as QueryBuilder;
use Yondu\Couchbase\Query\Grammar as QueryGrammar;
...
class Connection extends \Illuminate\Database\Connection
{
    ...
    protected $consistency = "requestPlus";
    ...
    {
        $connectionString = sprintf('couchbase://%s', $this->config['host']);
