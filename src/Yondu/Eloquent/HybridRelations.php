...
use Yondu\Couchbase\Relations\HasOne;
use Yondu\Couchbase\Relations\HasMany;
use Yondu\Couchbase\Relations\MorphTo;
use Yondu\Couchbase\Relations\BelongsTo;
use Yondu\Couchbase\Relations\BelongsToMany;
...
trait HybridRelations
{
    ...
    public function hasOne($related, $foreignKey = null, $localKey = null)
    {
        ...
        if (! is_subclass_of($related, 'Yondu\Eloquent\Model')) {
    ...
    public function belongsToMany($related, $collection = null, $foreignKey = null, $otherKey = null, $parentKey = null, $relatedKey = null, $relation = null)
    {
        ...
        // Check if it is a relation with an original model.
        if (! is_subclass_of($related, \Yondu\Eloquent\Model::class)) {
